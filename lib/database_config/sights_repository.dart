  ...
  Future<void> sightsDataInsertion() async {
    List<Map<String, dynamic>> dataList = [
      ...
      // Saborna crkva Vaskrsenja Gospodnjeg
      {
        ...
        'sight_image_path3': 'images/sightsImages/hram/hram3.jpeg',
        'latitude': 44.274172769846494,
        'longitude': 19.889581685484366,
        'titles': {
          'en': 'Church of the Resurrection of Christ',
          'de': 'Kirche der Auferstehung Christi',
          'sr': 'Hram Vaskrsenja Hristovog',
          'sr_Cyrl': 'Храм Васкрсења Христовог',
          'sr_Latn': 'Hram Vaskrsenja Hristovog',
        },
        'descriptions': {
          'en':
              'The primary and largest Orthodox church in Valjevo and the central church of the Valjevo Diocese of the Serbian Orthodox Church is dedicated to the Resurrection of Christ. It is located at the confluence of the Gradac River with the Kolubara River, and by size, it is the second in Serbia, following the Church of Saint Sava in Belgrade.\n\nConstruction began in 1992 and was completed in 2010 when it received its final exterior appearance, and work on the interior is still ongoing. It was built in the Serbian-Byzantine style, designed by architect Ljubica Bošnjak.\n\nThe length of the church is 46 meters, the width is 24 meters, and the height is 47 meters. The ground floor covers an area of 978 square meters and the gallery 229 square meters. The church is a gathering place for believers from around Serbia and an essential tourist destination.\n\n\nBehind this magnificent edifice lies another significant sanctuary - the Church of Saint Nectarios of Aegina (Image 3). Situated at the confluence of two rivers, it symbolizes the centuries-old friendship between the Serbian and Greek Orthodox churches. Above the confluence itself, there is a steel cross. The construction of the church began in 2015. It was built in the Greek-Byzantine style. The fresco painting reminds me of Greek churches because the light blue colour of the frescoes dominates. In 2018, a marble throne of Nectarios of Aegina with the reliquary of the saint himself was placed in the church. In front of the church is a fountain, a garden, and a mosaic at the very entrance to the church, as well as the flags of Greece, Serbia, and Saint Nectarios.',
          'de':
              'Die Haupt- und größte orthodoxe Kirche in Valjevo und die Zentralkirche der Diözese Valjevo der Serbisch-Orthodoxen Kirche ist dem Auferstehung Christi gewidmet. Sie befindet sich am Zusammenfluss des Flusses Gradac mit der Kolubara und ist nach der Größe die zweitgrößte in Serbien, nach der Kirche des Heiligen Sava in Belgrad.\n\nDer Bau begann im Jahr 1992 und wurde 2010 abgeschlossen, als sie ihr endgültiges äußeres Erscheinungsbild erhielt, und die Arbeiten am Inneren dauern noch an. Sie wurde im serbisch-byzantinischen Stil erbaut, entworfen von der Architektin Ljubica Bošnjak.\n\nDie Länge der Kirche beträgt 46 Meter, die Breite 24 Meter und die Höhe 47 Meter. Das Erdgeschoss umfasst eine Fläche von 978 Quadratmetern und die Galerie 229 Quadratmeter. Die Kirche ist ein Treffpunkt für Gläubige aus ganz Serbien und ein wichtiges touristisches Ziel.\n\n\nHinter diesem prächtigen Bauwerk liegt ein weiteres bedeutendes Heiligtum - die Kirche des Heiligen Nektarios von Aegina (Bild 3). Gelegen am Zusammenfluss zweier Flüsse, symbolisiert sie die jahrhundertealte Freundschaft zwischen den serbischen und griechischen orthodoxen Kirchen. Über dem Zusammenfluss selbst befindet sich ein Stahlkreuz. Der Bau der Kirche begann im Jahr 2015. Sie wurde im griechisch-byzantinischen Stil erbaut. Die Freskenmalerei erinnert an griechische Kirchen, da die hellblaue Farbe der Fresken dominiert. Im Jahr 2018 wurde ein Marmorthron des Nektarios von Aegina mit dem Reliquiar des Heiligen selbst in die Kirche gestellt. Vor der Kirche befinden sich ein Brunnen, ein Garten und ein Mosaik am Eingang der Kirche sowie die Flaggen von Griechenland, Serbien und des Heiligen Nektarios.',
          'sr':
              'Glavni i najveći pravoslavni hram u Valjevu i središnja crkva Valjevske eparhije Srpske Pravoslavne Crkve posvećen Hristovom Vaskrsenju. Nalazi se na ušću reke Gradac u Kolubaru, po veličini je drugi  u Srbiji iza Hrama Svetog Save u Beogradu.\n\nGradnja je započeta 1992. do 2010. godine kada je dobio završni spoljni izgled, a radovi na unutrašnjosti još uvek traju. Rađen je u srpsko-vizantijskom stilu, delo je arhitekte Ljubice Bošnjak.\n\nDužina hrama je 46 metara, širina 24 metra, a visina 47 metara. Prizemlje je površine 978 metara kvadratnih a galerija 229 metara kvadratnih. Hram je mesto sakupljanja vernika iz čitave Srbije i nezaobilazna turistička destinacija.\n\n\nIza ovog velelepnog zdanja nalazi se još jedna vredna svetkovina - Hram Svetog Nektarija Eginskog (Slika 3). Nastao na ušću dveju reka simbolizuje vekovno prijateljstvo Srpske i Grčke pravoslavne crkve. Iznad samog ušća nalazi se krst od čelika. Izgradnja hrama je počela 2015 godine. Građen je u grčko-vizantijskom stilu. Freskopis podseća na grčke crkve jer dominira svetloplava boja fresaka. 2018. godine u hram je postavljen mermerni tron Nektarija Eginskog sa kivotom samog sveca. Ispred hrama se nalazi fontana, vrt, mozaik na samom ulazu u hram, kao i zastave Grčke, Srbije i Svetog Nektarija.',
          'sr_Cyrl':
              'Главни и највећи православни храм у Ваљеву и средишња црква Ваљевске епархије Српске Православне Цркве посвећен Христовом Васкрсењу. Налази се на ушћу реке Градац у Колубару, по величини је други у Србији иза Храма Светог Саве у Београду.\n\nГрадња је започета 1992. до 2010. године када је добио завршни спољни изглед, а радови на унутрашњости још увек трају. Рађен је у српско-византијском стилу, дело је архитекте Љубице Бошњак.\n\nДужина храма је 46 метара, ширина 24 метра, а висина 47 метара. Први спрат је површине 978 метара квадратних а галерија 229 метара квадратних. Храм је место сакупљања верника из целе Србије и неизоставна туристичка дестинација.\n\n\nИза овог велелепног здања налази се још једна вредна светковина - Храм Светог Нектарија Егинског. Наcтaо на ушћу двеју река симболизује вековно пријатељство Српске и Грчке православне цркве. Изнад самог ушћа налази се крст од челика. Изградња храма је почела 2015. године. Грађен је у грчко-византијском стилу. Фрескопис подсећа на грчке цркве јер доминира светлоплава боја фресака. 2018. године у храм је постављен мермерни трон Нектарија Егинског са кивотом самог свеца (Слика 3). Испред храма се налази фонтана, врт, мозаик на самом улазу у храм, као и заставе Грчке, Србије и Светог Нектарија.',
          'sr_Latn':
              'Glavni i najveći pravoslavni hram u Valjevu i središnja crkva Valjevske eparhije Srpske Pravoslavne Crkve posvećen Hristovom Vaskrsenju. Nalazi se na ušću reke Gradac u Kolubaru, po veličini je drugi  u Srbiji iza Hrama Svetog Save u Beogradu.\n\nGradnja je započeta 1992. do 2010. godine kada je dobio završni spoljni izgled, a radovi na unutrašnjosti još uvek traju. Rađen je u srpsko-vizantijskom stilu, delo je arhitekte Ljubice Bošnjak.\n\nDužina hrama je 46 metara, širina 24 metra, a visina 47 metara. Prizemlje je površine 978 metara kvadratnih a galerija 229 metara kvadratnih. Hram je mesto sakupljanja vernika iz čitave Srbije i nezaobilazna turistička destinacija.\n\n\nIza ovog velelepnog zdanja nalazi se još jedna vredna svetkovina - Hram Svetog Nektarija Eginskog (Slika 3). Nastao na ušću dveju reka simbolizuje vekovno prijateljstvo Srpske i Grčke pravoslavne crkve. Iznad samog ušća nalazi se krst od čelika. Izgradnja hrama je počela 2015 godine. Građen je u grčko-vizantijskom stilu. Freskopis podseća na grčke crkve jer dominira svetloplava boja fresaka. 2018. godine u hram je postavljen mermerni tron Nektarija Eginskog sa kivotom samog sveca. Ispred hrama se nalazi fontana, vrt, mozaik na samom ulazu u hram, kao i zastave Grčke, Srbije i Svetog Nektarija.'
        },
      },
      ...
      // Gradac
      {
        'sight_image_path': 'images/sightsImages/gradac/gradac1.jpg',
        'sight_image_path2': 'images/sightsImages/gradac/gradac2.jpg',
        'sight_image_path3': 'images/sightsImages/gradac/gradac3.jpg',
        'latitude': 44.255941632141706,
        'longitude': 19.88782039559994,
        'titles': {
          'en': 'Gradac River - "The Pearl of Western Serbia"',
          'de': 'Gradac Fluss - "Die Perle Westserbiens"',
          'sr': 'Reka Gradac - "Biser zapadne Srbije"',
          'sr_Cyrl': 'Река Градац - "Бисер западне Србије"',
          'sr_Latn': 'Reka Gradac - "Biser zapadne Srbije"',
        },
        'descriptions': {
          'en':
              'Gradac is the cleanest river in Western Serbia and one of the cleanest European rivers, located 5 km from the city centre.\n\nThis river is a ponor, originating from beneath Mount Povlen. After several kilometres, it disappears underground and re-emerges near the village of Bogatić, above the Ćelije Monastery - a 13th-century endowment of King Dragutin Nemanjić. The river is formed by the confluence of the Bukovska River and Zabava, flowing through a gorge landscape for 28 kilometres, with a total drop of 187 meters. The canyon, 22.7 kilometres long, a "masterpiece of nature," has been formed over centuries. There are over 70 known caves along its course, among which Degurićka cave stands out with its corridors, size, and beauty of cave ornaments. Nearby is a dam, a popular swimming spot for the people of Valjevo. Gradac, the most water-abundant tributary of the Kolubara, has been protected by the Institute for Nature Conservation of Serbia since 2001 due to its cleanliness and untouched nature. The protected area of 1268 hectares is home to 400 plant species, 240 types of fungi, 38 species of amphibians and reptiles, and many birds. Gradac is a habitat for otters, brown trout, and the rare freshwater fish paklara, which only lives in clean waters. Among reptiles, the horned viper is notable. There is also a belief that this area was inhabited as far back as the Paleolithic era.\n\nAll these natural features make Gradac a true "Pearl of Western Serbia".',
          'de':
              'Gradac ist der sauberste Fluss in Westserbien und einer der saubersten Flüsse Europas, gelegen 5 km vom Stadtzentrum entfernt.\n\nDieser Fluss ist ein Ponor, der unterhalb des Berges Povlen entspringt. Nach mehreren Kilometern verschwindet er unterirdisch und tritt wieder in der Nähe des Dorfes Bogatić, oberhalb des Klosters Ćelije - einer Stiftung des Königs Dragutin Nemanjić aus dem 13. Jahrhundert, zutage. Der Fluss entsteht durch den Zusammenfluss des Bukovska Flusses und der Zabava und fließt durch eine Schluchtenlandschaft über 28 Kilometer, mit einem Gesamtabfall von 187 Metern. Der Canyon, 22,7 Kilometer lang, ein "Naturmeisterwerk", wurde über Jahrhunderte geformt. Entlang seines Verlaufs gibt es über 70 bekannte Höhlen, unter denen die Degurićka-Höhle mit ihren Korridoren, ihrer Größe und der Schönheit ihrer Höhlenornamente heraussticht. In der Nähe befindet sich ein Damm, ein beliebter Badeplatz für die Menschen aus Valjevo. Gradac, der wasserreichste Nebenfluss der Kolubara, steht seit 2001 aufgrund seiner Sauberkeit und unberührten Natur unter Schutz des Instituts für Naturschutz Serbiens. Das geschützte Gebiet von 1268 Hektar beherbergt 400 Pflanzenarten, 240 Pilzarten, 38 Arten von Amphibien und Reptilien sowie viele Vögel. Gradac ist ein Lebensraum für Otter, Bachforellen und den seltenen Süßwasserfisch Paklara, der nur in sauberen Gewässern lebt. Unter den Reptilien ist die Hörnchenotter bemerkenswert. Es gibt auch den Glauben, dass dieses Gebiet bereits in der Altsteinzeit bewohnt war.\n\nAll diese natürlichen Merkmale machen Gradac zu einem wahren "Perl von Westserbien".',
          'sr':
              'Gradac je najčistija reka zapadne Srbije, i jedna od najčistijih evropskih reka, nalazi se na 5 km od centra grada.\n\nOvo je ponornica koja izvire ispod planine Povlen, a nakon nekoliko kilometara toka ponire i ponovo izbija na površinu kod sela Bogatić, iznad manastira Ćelije - zadužbine kralja Dragutina Nemanjića iz 13. veka. Reka nastaje spajanjem Bukovske reke i Zabave, teče klisurastim krajolikom dužinom od 28 kilometara, sa ukupnim padom od 187 metara. Kanjon dugačak 22,7 kilometara, "remek-delo prirode", stvaran je vekovima. Duž toka nalazi se preko 70 poznatih pećina, među kojima se ističe Degurićka pećina svojim hodnicima, veličinom i lepotom pećinskog nakita. U blizini je i brana, popularno kupalište Valjevaca. Gradac, najbogatija vodom među pritokama Kolubare, zbog svoje čistoće i netaknute prirode, pod zaštitom je Instituta za Zaštitu Prirode Srbije od 2001. godine. Na zaštićenom području od 1268 hektara živi 400 vrsta biljaka, 240 vrsta gljiva, 38 vrsta vodozemaca i gmizavaca, te veliki broj ptica. Gradac je dom vidre, potočne pastrmke i retke slatkovodne ribe paklare, koja živi samo u čistim vodama. Među gmizavcima se izdvaja poskok. Postoji i verovanje da je ovo područje bilo naseljeno još u paleolitu.\n\nSve ove prirodne karakteristike čine Gradac pravim "Biserom zapadne Srbije".',
          'sr_Cyrl':
              'Градац је најчистија река западне Србије, и једна од најчистијих европских река, налази се на 5 км од центра града.\n\nОво је понорница која извире испод планине Повлен, а након неколико километара тока понире и поново избија на површину код села Богатић, изнад манастира Ћелије - задужбине краља Драгутина Немањића из 13. века. Река настаје спајањем Буковске реке и Забаве, тече клисурастим крајоликом дужином од 28 километара, са укупним падом од 187 метара. Кањон дугачак 22,7 километара, "ремек-дело природе", стваран је вековима. Дуж тока налази се преко 70 познатих пећина, међу којима се истиче Дегурићка пећина својим ходницима, величином и лепотом пећинског накита. У близини је и брана, популарно купалиште Ваљеваца. Градац, најбогатија водом међу притокама Колубаре, због своје чистоће и нетакнуте природе, под заштитом је Института за Заштиту Природе Србије од 2001. године. На заштићеном подручју од 1268 хектара живи 400 врста биљака, 240 врста гљива, 38 врста водоземаца и гмизаваца, те велики број птица. Градац је дом видре, поточне пастрмке и ретке слатководне рибе пакларе, која живи само у чистим водама. Међу гмизавцима се издваја поскок. Постоји и веровање да је ово подручје било насељено још у палеолиту.\n\nСве ове природне карактеристике чине Градац правим "Бисером западне Србије".',
          'sr_Latn':
              'Gradac je najčistija reka zapadne Srbije, i jedna od najčistijih evropskih reka, nalazi se na 5 km od centra grada.\n\nOvo je ponornica koja izvire ispod planine Povlen, a nakon nekoliko kilometara toka ponire i ponovo izbija na površinu kod sela Bogatić, iznad manastira Ćelije - zadužbine kralja Dragutina Nemanjića iz 13. veka. Reka nastaje spajanjem Bukovske reke i Zabave, teče klisurastim krajolikom dužinom od 28 kilometara, sa ukupnim padom od 187 metara. Kanjon dugačak 22,7 kilometara, "remek-delo prirode", stvaran je vekovima. Duž toka nalazi se preko 70 poznatih pećina, među kojima se ističe Degurićka pećina svojim hodnicima, veličinom i lepotom pećinskog nakita. U blizini je i brana, popularno kupalište Valjevaca. Gradac, najbogatija vodom među pritokama Kolubare, zbog svoje čistoće i netaknute prirode, pod zaštitom je Instituta za Zaštitu Prirode Srbije od 2001. godine. Na zaštićenom području od 1268 hektara živi 400 vrsta biljaka, 240 vrsta gljiva, 38 vrsta vodozemaca i gmizavaca, te veliki broj ptica. Gradac je dom vidre, potočne pastrmke i retke slatkovodne ribe paklare, koja živi samo u čistim vodama. Među gmizavcima se izdvaja poskok. Postoji i verovanje da je ovo područje bilo naseljeno još u paleolitu.\n\nSve ove prirodne karakteristike čine Gradac pravim "Biserom zapadne Srbije".'
        },
      },
