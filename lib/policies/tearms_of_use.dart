...
List<Widget> _buildTermsOfUseContent(BuildContext context) {
  return [
    ...
    _buildSection(context, localization(context).termination,
        localization(context).terminationContent),
    _buildSection(context, localization(context).disclaimer,
        localization(context).disclaimerContent),
    _buildSection(context, localization(context).limitiations,
        localization(context).limitiationsContent),
    _buildSection(context, localization(context).governingLaw,
        localization(context).governingLawContent),
